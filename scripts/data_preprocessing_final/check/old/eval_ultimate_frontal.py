...
# ==============================================================================
# ---- 场景一: Frontal — Ultimate 全量微调评估 ----
SCENE_NAME = 'frontal'
CKPT_PATH = "outputs/det/CRN_frontal_ultimate_finetune/lightning_logs/version_1/checkpoints/last.ckpt"
OUTPUT_DIR = "work_dirs/eval_ultimate_frontal"
