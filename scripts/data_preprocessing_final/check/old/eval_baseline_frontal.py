...
# ==============================================================================
# ---- 场景一: Frontal — Baseline 微调评估 ----
SCENE_NAME = 'frontal'
CKPT_PATH = "outputs/det/CRN_frontal_baseline_finetune/lightning_logs/version_0/checkpoints/epoch=7-step=11680.ckpt"
OUTPUT_DIR = "work_dirs/eval_baseline_frontal"
